...
public class JustifyTextView extends AppCompatTextView {
    ...
    private void init(AttributeSet attrs) {
        ...
        //TypedArray customTa = getContext().obtainStyledAttributes(attrs, R.styleable.JustifyTextView, 0, 0);

        //justify = customTa.getBoolean(R.styleable.TextAttributes_justify, false);
